...
const ParallelCoordinatesStory = () => {
    return (
        <div style={{ display: "flex", flexDirection: "column", height: "100%", maxWidth: "70%", margin: "auto", justifyContent: "center" }}>
            ...
            <br /><br />
            Can money buy happiness? Try selecting countries with the highest GDP. It seems they are all ranked very high on happines score axis.
